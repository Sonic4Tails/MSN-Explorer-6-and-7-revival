...
<?php
	$__server->page_embeds->page_title = "youtube - Sign In";
	$__server->page_embeds->page_description = "youtube is a site dedicated to bring back the 2012 layout of YouTube.";
			...
			<div id="content-container">
				...
				<div id="content" style="">
					...
					<div class="www-left">
						...
						Sign up now to get full access with your youtube account: <br><br>
						<ul>
						...
						</ul><br><a href="/sign_up">Sign up now </a> to join the youtube community.<br>
<br><br>
					</div>
					<div class="www-right">
